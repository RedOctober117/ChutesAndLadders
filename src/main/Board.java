...
/**
 * Board allows a user to draw a Chutes and Ladders playspace and its players
        ...
        for (int i = 1; i < 31; i++) {
          ...
          if (i % 3 == 0) {
            ...
            for (int j = 0; j <= dimension * 6; j++) {
              // If player1's location matches the j and i of the printer, print the initial
              // of player1.
      ...
      case 2:
        ...
        for (int i = 1; i < 31; i++) {
          ...
          if (i % 3 == 0) {
            ...
            // Determine the size of the board.
            for (int j = 0; j <= dimension * 6; j++) {
              // If player1 or 2's location matches the j and i of the printer, print the
              // initial of player1 or 2.
              if ((p1.getPlayerX() == j && p1.getPlayerY() == i) || (p2.getPlayerX() == j && p2.getPlayerY() == i)) {
                if (p1.getPlayerX() == j && p1.getPlayerY() == i) {
                  // If player1 resides at the (j,i) coords, print player1's initial, else print
                  // 2's.
                  System.out.printf("%c", p1.getInitial());
                } else {
      ...
      case 3:
        ...
        for (int i = 1; i < 31; i++) {
          ...
          if (i % 3 == 0) {
            ...
            // Determine the size of the board.
            for (int j = 0; j <= dimension * 6; j++) {
              // If player1, 2, or 3's location matches the j and i of the printer, print the
              // initial of the cooresponding player.
              if ((p1.getPlayerX() == j && p1.getPlayerY() == i) || (p2.getPlayerX() == j && p2.getPlayerY() == i)
                  || (p3.getPlayerX() == j && p3.getPlayerY() == i)) {
                if (p1.getPlayerX() == j && p1.getPlayerY() == i) {
      ...
      case 4:
        ...
        for (int i = 1; i < 31; i++) {
          ...
          if (i % 3 == 0) {
            ...
            for (int j = 0; j <= dimension * 6; j++) {
              // Determine if any player's (j,i) match the printers (j,i). If one does,
              // proceed to the `if` block to determine who.
              if ((p1.getPlayerX() == j && p1.getPlayerY() == i) || (p2.getPlayerX() == j && p2.getPlayerY() == i)
                  || (p3.getPlayerX() == j && p3.getPlayerY() == i) || (p4.getPlayerX() == j && p4.getPlayerY() == i)) {
