...
public class Token {
     ...
     */
    public Token(char initialInput, int playerX, int playerY) {
        this.initial = initialInput;
        this.playerX = playerX;
        // The below offsets the players y to circumvent an issue in Board that,
        // frankly, I don't feel like fixing.
    ...
    public int getSpace() {
        ...
        /*
         * there are 4 cases present: player1's character, player2's character,
         * player3's character, or player4's character.
